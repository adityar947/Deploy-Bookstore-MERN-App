...
app.use(cors({
  origin: 'https://frontend-nrgo.onrender.com', // allow both
...
mongoose.connect('mongodb+srv://root:0O9marHJrva1111b@cluster0.hpq7bn0.mongodb.net/?retryWrites=true&w=majority')
...
app.post('/login', async (req, res) => {
  try {
    ...
    const token = jwt.sign({ userId: user._id }, "secretkey"); // Use env var for secret in prod
    res.json({ token });
  } catch {
